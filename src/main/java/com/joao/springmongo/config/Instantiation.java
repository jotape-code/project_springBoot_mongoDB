...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        CommentDTO com1 = new CommentDTO("Boa viagem mano!", Instant.from(stf.parse("21/03/2018 17:00")), new AuthorDTO(alex));
        CommentDTO com2 = new CommentDTO("Aproveite!", Instant.from(stf.parse("22/03/2018 18:00")), new AuthorDTO(bob));
        CommentDTO com3 = new CommentDTO("Tenha um ótimo dia!", Instant.from(stf.parse("23/03/2018 18:00")), new AuthorDTO(alex));
